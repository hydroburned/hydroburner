(function () {
  ...
  const DownloadIcon = (props) => e('svg', { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", ...props }, e('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" }));
  ...
  const HomePage = () => {
    ...
    return e('div', { className: "overflow-x-hidden" },
      e('section', { className: "relative h-screen flex items-center" }, e(FloatingGradient, null), e('div', { className: "relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8" }, e('div', { className: "max-w-3xl" },
        e('h1', { className: "font-heading text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-gray-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-white dark:to-gray-400" }, "Nikita Makarov"),
        e('p', { className: "font-heading mt-4 text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-gray-200 transition-colors duration-300" }, "Senior Product Designer"),
        e('p', { className: "mt-6 max-w-2xl text-lg md:text-xl text-gray-600 dark:text-gray-400 transition-colors duration-300" }, "A natural problem solver, I turn B2B chaos into scalable, beautiful systems that empower users and accelerate business growth."),
        e('div', { className: "mt-12 flex flex-wrap items-center justify-start gap-4" },
          ...
          e('a', { href: "./cv.pdf", download: true, className: "inline-flex items-center gap-2 px-8 py-4 bg-black/5 dark:bg-white/10 text-gray-800 dark:text-white rounded-full backdrop-blur-sm border border-black/10 dark:border-white/20 hover:bg-black/10 dark:hover:bg-white/20 transition-all duration-300 group" }, "Download CV", e(DownloadIcon, { className: "w-5 h-5" }))
        ),
        e('div', { className: "mt-10 flex items-center justify-start gap-6" },
      ...
      e('section', { id: "about", className: "py-20 md:py-32 scroll-mt-20" }, e('div', { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, e('div', { className: "max-w-5xl grid md:grid-cols-3 gap-8 md:gap-12 items-center" },
        e('div', { className: "md:col-span-1" }, e('img', { src: "https://picsum.photos/seed/portrait/500/500", alt: "Nikita Makarov", className: "rounded-full aspect-square object-cover mx-auto w-48 h-48 md:w-full md:h-auto" })),
        e('div', { className: "md:col-span-2" },
          e('h2', { className: "font-heading text-3xl md:text-4xl font-bold tracking-tight" }, "About Me"),
          e('p', { className: "mt-6 text-lg text-gray-600 dark:text-gray-400 transition-colors duration-300" }, "With 8+ years in the trenches of SaaS, I've honed my craft shaping complex B2B/B2C products for web and mobile. My journey began in industrial design, which instilled in me a deep appreciation for form, function, and human-centered problem-solving."),
          e('p', { className: "mt-4 text-lg text-gray-600 dark:text-gray-400 transition-colors duration-300" }, "When I'm not untangling user flows, you'll find me trying to catch waves—a passion that teaches me patience and respect for powerful systems. I thrive in remote, global teams and am currently planning a relocation to Brazil with my family, embracing new cultures and perspectives.")
        )
      ))),
      e('section', { id: "projects", className: "py-20 md:py-32 scroll-mt-20" }, e('div', { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-12 md:mb-16" }, e('h2', { className: "font-heading text-4xl md:text-5xl font-bold tracking-tight" }, "Selected Projects"), e('p', { className: "mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-400 transition-colors duration-300 mx-auto" }, "A selection of projects where I've made a tangible impact.")), e(CurvedGallery, { projects: projects })),
      e('section', { id: "live-sites", className: "py-20 md:py-32 scroll-mt-20" }, e('div', { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, e('div', { className: "text-left mb-12 md:mb-16" }, e('h2', { className: "font-heading text-4xl md:text-5xl font-bold tracking-tight" }, "Live Websites"), e('p', { className: "mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-400" }, "A few client projects I've designed and built from the ground up.")), e('div', { className: "grid grid-cols-1 md:grid-cols-2 gap-8" }, liveProjects.slice(0, 4).map(project => e(LiveProjectCard, { key: project.id, project: project }))))),
      e(Skills, null),
      e('section', { id: "values", className: "relative py-20 md:py-32 scroll-mt-20" }, e(FloatingGradient, { reverse: true }), e('div', { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, e('div', { className: "max-w-3xl text-left mb-12 md:mb-16" }, e('h2', { className: "font-heading text-4xl md:text-5xl font-bold tracking-tight" }, "My Design Philosophy"), e('p', { className: "mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-400 transition-colors duration-300" }, "The core principles that guide my work and my approach to problem-solving.")), e('div', { className: "grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12" }, values.map(value => e('div', { key: value.title, className: "bg-white/30 dark:bg-gray-900/40 backdrop-blur-lg p-6 rounded-2xl border border-white/40 dark:border-white/20 transition-all duration-300 hover:border-blue-500/50 hover:-translate-y-1" }, e('h3', { className: "font-heading text-xl font-bold text-gray-900 dark:text-white transition-colors duration-300" }, value.title), e('p', { className: "mt-2 text-gray-600 dark:text-gray-400 transition-colors duration-300" }, value.description)))))),
      e('section', { id: "contact", className: "py-20 md:py-32 scroll-mt-20 pb-28 md:pb-20" }, e('div', { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, e('div', { className: "max-w-3xl text-center mx-auto" }, e('h2', { className: "font-heading text-5xl md:text-7xl font-bold tracking-tight" }, "Let's work together."), e('p', { className: "mt-6 text-lg text-gray-600 dark:text-gray-400 transition-colors duration-300" }, "Have a project in mind? I'm always open to discussing new opportunities, collaborations, or just talking about design and surfing."), e('a', { href: "mailto:contact@example.com", className: "mt-12 inline-block text-2xl md:text-3xl font-medium text-gray-900 dark:text-white border-b-2 border-dotted border-gray-400 dark:border-gray-500 hover:border-gray-900 dark:hover:border-white transition-colors duration-300" }, "Get in touch"))))
    );
  };
  const CaseStudyPage = () => {
